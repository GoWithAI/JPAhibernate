package test.practice.beanFactoryAndApplicationContext;
...
public class AppllicationTest {
	...
	public static void main(String[] args) {
		...
		//Employee employee2 = (Employee) factory.getBean("e1");
		...
		//Employee employee4=(Employee)applicationContext.getBean("e1");
